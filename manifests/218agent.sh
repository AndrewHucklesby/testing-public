...
main() {
    ...
    curl -L  https://downloads.portainer.io/ee2-18/portainer-agent-edge-k8s.yaml -o portainer-agent-edge-k8s.yaml || errorAndExit "Unable to download agent manifest"
